...
/*
hould return the name of the supported algorithm for the operation operation_id. This is similar to
provider_query_operation() (see provider-base), but only works as an advisory. If this function is not present, or
